  ...
  <DialogHeader>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between pb-4 border-b h-fit gap-2">
      <div class="flex w-full items-center justify-between gap-2">
        <template v-if="!uiStore.isMobile && currentMode === 'list'">
          <Tabs
            v-model="tab"
        ...
        <template v-else-if="uiStore.isMobile && currentMode === 'list'">
        ...
        <template v-else-if="!uiStore.isMobile && currentMode === 'detail'">
          <Tabs
            v-model="lockerTab"
      ...
      <div class="flex items-center justify-end gap-2 w-full md:w-fit">
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="outline" class="flex items-center gap-2">
        ...
        <Button variant="primary" class="w-full md:w-fit" @click="emit('create-locker')">
