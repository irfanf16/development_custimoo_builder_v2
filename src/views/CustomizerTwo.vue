...
import { CategoryPanel, MenuPanel, ProductPanel } from '@/components/customizer-panel'
import { ref } from 'vue';
        ...
        <div id="main-content" class="flex-col w-full z-10 border border-red-500">
            <div id="top-content" class="flex-row border border-blue-500">
                <div id="left-content" class="flex flex-row border border-yellow-500">
                    <div id="menu-items-container" class="flex-col border border-pink-500">
                        <CustomizerMenu />
                    </div>
                    <div id="menu-panel-container" class="flex-col border border-green-500">
                        <MenuPanel
                ...
                <div id="right-content" class="flex-row border border-purple-500">
                    <div id="canvas-controls-container" class="flex-col borderborder-orange-500">
                    </div>
                </div>
            </div>
            <div id="bottom-content" class="flex flex-row justify-between p-6 border border-green-500 h-[153px]">
                <BottomActions />
                <PriceCard />
            </div>
        </div>
