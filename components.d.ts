...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    'IFlexLineAiEditSpark-StreamlineFlex': typeof import('~icons/flex-line/ai-edit-spark--streamline-flex')['default']
    'IFlexLineAiSparkles-StreamlineFlex': typeof import('~icons/flex-line/ai-sparkles--streamline-flex')['default']
    'IFlexLineCategories-StreamlineFlex': typeof import('~icons/flex-line/categories--streamline-flex')['default']
    'IFlexLineLandscape1-StreamlineFlex': typeof import('~icons/flex-line/landscape1--streamline-flex')['default']
    'IFlexLinePaintPalette-StreamlineFlex': typeof import('~icons/flex-line/paint-palette--streamline-flex')['default']
    'IFlexLinePattern-StreamlineFlex': typeof import('~icons/flex-line/pattern--streamline-flex')['default']
